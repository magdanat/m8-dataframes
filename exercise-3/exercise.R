...
salaries.2015 <- salaries.2014 + runif(100, -500, 10000)


# Create a data.frame 'salaries' by combining the 3 vectors you just made
# Remember to set `stringsAsFactors=FALSE`!
salaries <- data.frame(employees, salaries.2014, salaries.2015, stringAsFactors = FALSE)
...
# nrow(salaries[salaries$got.raise, ]) # gives data set for everyone who got raise
